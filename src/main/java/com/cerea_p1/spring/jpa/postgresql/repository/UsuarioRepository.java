...
public interface UsuarioRepository extends JpaRepository<Usuario,String> {
    ...
    @Query("SELECT a.username, a.puntos, a.pais FROM ((Usuario u INNER JOIN u.amigos a  WHERE :username = u.username) UNION (SELECT z.username, z.puntos, z.pais FROM Usuario z WHERE :username = z.username)) ORDER BY a.puntos DESC")
